        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="../Drives/index.php">Sinhgad Institute Of Management</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="../Profilers/PriProfile/index.php">Principle Login</a>
                        </li>
                    </ul>
        ...
        <header>
            <div class="header-content">
                <div class="header-content-inner">
                    <h1>COLLEGE PLACEMENT 2021</h1>
                    <hr>
                    <p>We are here to Build your Skills and Career with our Driven Passion and Reality.</br>
                        Details</p>
                    <a href=" ../Profilers../PProfile/Placement Drives/viewCompanydetails.php"></a>
                </div>
            </div>
        </header>
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>India</p>
					<p>7517654390</p>
					<a href="hitzpatil2399@gmail.com">hitzpatil2399@gmail.com</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Copyright &copy;Hitakshi Technologies
				</div>
