      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
               <li><a href="../../Homepage/home.php">Home SIOMch </a></li>
        ...
        <div class="templatemo-content-container">
          ...
          <footer class="text-right">
            <p>Copyright &copy;  2021 SIOM  
            | Developed by <a href="http://waffer,wordpress.com" target="_parent">Hitakshi Developers</a></p>
          </footer>
        </div>
      </div>
    </div>
