    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
           <ul>
             <li><a href="../../SProfile/login.php"><i class="fa fa-home fa-fw"></i>Dashboard</a></li> 
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="../../../Drives/index.php"> Home</a></li>
               <li><a href="../../../Homepage/home.php">Drives Home </a></li>
...
<td><a  class="white-text templatemo-sort-by">HSC/Dip </a></td>
   <td><a  class="white-text templatemo-sort-by">PG</a></td>               
...
$prev = $currentpage-1;
 ...
 ?> 
          ...
          <footer class="text-right">
           		<p>Copyright &copy; XYZ Technologies
			  </p>
          </footer>         
        </div>
      </div>
