      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
           <ul>
            ...
            <li><a href="Students Eligibility.php" class="active"><i class="fa fa-sliders fa-fw"></i>View Students By Criteria</a></li>
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
               <li><a href="../../Homepage/home.php">Home SIOM </a></li>
...
<div class="templatemo-content-container"><H2>View Students By Criteria</H2>
